...
## Automate Deployment Resources ด้วยการใช้ Azure Resource Manager (ARM) Template หรือ Bicep File

- Interpret ARM Template หรือ Bicep file
...
- Template เป็น Declarative (https://codinggun.com/iac) และสามารถใช้ Manage Infrastructure แทนที่จะใช้ Script
...
Azure Bicep คือ Domain-Specific Language (DSL) สามารถใช้แทนที่ JSON ในการเขียน ARM Template เป็นภาษามนุษย์มากกว่า ปัจจุบันเป็น Bicep หมดแล้ว
