...
Virtual Networks ก็คือ Network ใน Cloud การทำงานกับ VNet (AWS VPC) Service ใน Azure เหมือนกับ Traditional Network On-prem แต่จะมีข้อดีบางอย่างเพิ่มขึ้นมา:
- Availability
- Network Isolation
- Scalability
...
- https://www.youtube.com/watch?v=ITofRRcekxI
